  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      for (const file of attachments) {
        ...
        formDataFile.append('attachment', file);

        const uploadResponse = await axios.post('http://localhost:5000/api/upload', formDataFile, {
      ...
      const taskPromises = formData.assignedTo.map(async (assignedUserId) => {
        ...
        return axios.post('http://localhost:5000/api/tasks/create-scheduled', taskData);
      });
